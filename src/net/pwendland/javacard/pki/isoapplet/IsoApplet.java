...
public class IsoApplet extends Applet implements ExtendedLength {
    ...
    // SO PIN:
    private static final byte SOPIN_REF = (byte) 0xF;
     ...
     */
    private void getDefaultConfig(byte[] bArray, short bOffset, byte bLength, boolean init)
    {
    ...
    protected IsoApplet(byte[] bArray, short bOffset, byte bLength) {
        api_features = 0;
        getDefaultConfig(bArray, bOffset, bLength, true);
    ...
    private void processInitialiseCard(APDU apdu) {
        ...
        if( state == STATE_CREATION ) {
            ...
            if (lc > 0) {
                ...
                getDefaultConfig(buf, apdu.getOffsetCdata(), (byte)lc, false);
            }
